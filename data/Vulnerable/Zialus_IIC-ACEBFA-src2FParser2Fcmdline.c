/*
  ...
  gengetopt --input=/home/travis/build/Zialus/IIC-ACEBFA/src/Parser/cmdline.ggo --include-getopt --output-dir=/home/travis/build/Zialus/IIC-ACEBFA/src/Parser/ 
...
const char *gengetopt_args_info_usage = "Usage: myApp [OPTIONS]...";
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->fileout_mem_orig = NULL;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->fileout_mem_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->fileout_mem_given)
    write_into_file(outfile, "fileout_mem", args_info->fileout_mem_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->fileout_time_given)
    {
      fprintf (stderr, "%s: '--fileout_time' option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->fileout_mem_given)
    {
      fprintf (stderr, "%s: '--fileout_mem' option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "fileout_time") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->fileout_time_arg), 
                 &(args_info->fileout_time_orig), &(args_info->fileout_time_given),
                &(local_args_info.fileout_time_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "fileout_time", '-',
                additional_error))
              goto failure;
          ...
          /* Output Memory filename.  */
          else if (strcmp (long_options[option_index].name, "fileout_mem") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->fileout_mem_arg), 
                 &(args_info->fileout_mem_orig), &(args_info->fileout_mem_given),
                &(local_args_info.fileout_mem_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "fileout_mem", '-',
                additional_error))
              goto failure;
