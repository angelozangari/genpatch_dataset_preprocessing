...
Raj Gejjagaraguppe(ARC) Aug, 1996       Landsat Ratio is removed as hard
...
static void som_series(double *fb, double *fa2, double *fa4, 
...
long   start1,
long   flag,
double sat_ratio)               /* satellite ratio which specify the 
                                   start point of x,y reading within an 
                                   orbit                                */ 
{
long i;
...
genrpt(gsat_ratio, "Landsat Ratio:    ");
